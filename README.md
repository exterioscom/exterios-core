...
Exterios Core is the BitShares blockchain implementation and command-line interface.
...
[here](https://github.com/exterioscom/exterios-core/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).
...
- What is the meaning of `a.b.c` numbers?
    ...
    complete list of type ID's, see `enum object_type` and `enum impl_object_type` 
...
License
-------
BitShares Core is under the MIT license. See [LICENSE](https://github.com/exterioscom/exterios-core/blob/master/LICENSE.txt)
